...
var TransitRouter = class TransitRoute {
    ...
    fetchFirstResults() {
        ...
        if (this._currProvider) {
            if (this._currProvider.attribution)
                this._plan.attribution = this._currProvider.attribution;
            if (this._currProvider.attributionUrl)
                this._plan.attributionUrl = this._currProvider.attributesUrl;
    ...
    fetchMoreResults() {
        if (this._currProvider)
            this._currProvider.fetchMoreResults();
        else
