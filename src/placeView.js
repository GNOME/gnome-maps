...
export class PlaceView extends Gtk.Box {
    ...
    constructor({place, mapView, inlineMode, ...params}) {
        ...
        if (this.place instanceof CoordinatePlace || !this.place.osmType) {
    ...
    updatePlaceDetails() {
         ...
         */
        if (place instanceof CoordinatePlace &&
            place.name === place.coordinateDescription) {
    ...
    _createContent(place) {
        ...
        if (place instanceof CoordinatePlace) {
            let coordinates = place.coordinateDescription;
