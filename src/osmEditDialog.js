...
const OSM_FIELDS = [
    ...
    },
    {
         ...
         * belonging the previous sections ("General", "Contact", "Accessibility").
         */
...
export class OSMEditDialog extends Adw.Dialog {
    ...
    _addOSMEditComboEntry(group, category, value) {
        ...
        /* Translators: This is the title for a combo box row selected when
         * an value is not assigned to one in a list of allowed values.
         */
