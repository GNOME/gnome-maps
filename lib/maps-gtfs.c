...
process_stop_time (MapsGTFS *gtfs, GHashTable *entry)
{
  ...
  gchar *shape_dist_travelled = g_hash_table_lookup (entry, "shape_dist_travelled");
  ...
  gfloat shape_dist_travelled_float =
                     shape_dist_travelled ?
                     g_ascii_strtod (shape_dist_travelled, NULL) : G_MINFLOAT;
