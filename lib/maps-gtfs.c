...
parse_pickup_drop_off (const gchar *pickup_drop_off)
{
...
process_calendar (GHashTable *entry, sqlite3_stmt *p_stmt)
{
  ...
  sqlite3_bind_int (p_stmt, 2, g_ascii_strtoull (monday, NULL, 10));
  sqlite3_bind_int (p_stmt, 3, g_ascii_strtoull (tuesday, NULL, 10));
  sqlite3_bind_int (p_stmt, 4, g_ascii_strtoull (wednesday, NULL, 10));
  sqlite3_bind_int (p_stmt, 5, g_ascii_strtoull (thursday, NULL, 10));
  sqlite3_bind_int (p_stmt, 6, g_ascii_strtoull (friday, NULL, 10));
  sqlite3_bind_int (p_stmt, 7, g_ascii_strtoull (saturday, NULL, 10));
  sqlite3_bind_int (p_stmt, 8, g_ascii_strtoull (sunday, NULL, 10));
