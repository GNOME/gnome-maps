...
{
  MapsGTFSStop *stop = MAPS_GTFS_STOP (g_object_new (MAPS_TYPE_GTFS_STOP,
                                                    NULL));
                             ...
                             GValue  *value)
{
  ...
  switch (prop_id)
    ...
    case PROP_CODE:
      ...
      break;
    case PROP_NAME:
      g_value_get_string (value, priv->name);
      break;
    case PROP_DESC:
      g_value_get_string (value, priv->desc);
      break;
    case PROP_LAT:
      g_value_get_float (value, priv->lat);
      break;
    case PROP_LON:
      g_value_get_float (value, priv->lon);
      break;
    case PROP_LOCATION_TYPE:
      g_value_get_enum (value, priv->location_type);
      break;
    case PROP_PARENT_STATION:
      g_value_get_object (value, priv->parent_station);
      break;
    case PROP_TIMEZONE:
      g_value_get_boxed (value, priv->timezone);
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
    }
